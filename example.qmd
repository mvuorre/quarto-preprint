...
>--Buckheit and Donoho [-@buckheitWaveLabReproducibleResearch1995, paraphrasing Jon Claerbout]
...
Code (@lst-code) font can be specified with the `codefont` variable.
...
@nte-example shows a cross-referenced box.

::: {#nte-example .callout-note icon=false}
## Boxes
Boxes are simplified [Quarto note callouts](https://quarto.org/docs/authoring/callouts.html) perhaps more suitable for academic PDF outputs, but preserve their original style in other output formats.
:::
