  ...
  html:
    ...
    other-links:
      ...
      - text: Example PDF
        href: example.pdf
        icon: filetype-pdf
      - text: Example Journal theme PDF
        href: example-jou.pdf
        icon: filetype-pdf
      - text: Example HTML
        href: example.html
        icon: filetype-html
...
In two-column documents, you can create full-width content using the `place` function. This figure (@fig-wide) spans the full page width:
